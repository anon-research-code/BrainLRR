...
# helps the plain baseline.
# Usage (run from repo root):
#   python scripts/train_baseline_fixed_hp.py --dataset abide --lr 7.74e-05 --wd 0.0235
#   python scripts/train_baseline_fixed_hp.py --dataset abide   (falls back to Optuna search)
...
if __name__ == "__main__":
    ...
    out_csv = f"results_{args.dataset}_baseline{hp_suffix}.csv"
