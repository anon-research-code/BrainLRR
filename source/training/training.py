...
class Train:
    ...
    def __init__(self, cfg: DictConfig,
        ...
        weight_tensor = torch.tensor(class_weights).float().cuda() if class_weights else None
        self.loss_fn = torch.nn.CrossEntropyLoss(weight=weight_tensor, reduction='sum')
